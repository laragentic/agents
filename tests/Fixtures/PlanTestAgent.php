...
/**
 * A test agent that uses PlanExecuteLoop with controllable prompt responses.
 *
 * Returns pre-configured AgentResponse objects in sequence:
 * 1st call  → planning response (should contain numbered steps)
 * 2nd..Nth  → step execution responses
 * Last call → synthesis response
 */
class PlanTestAgent
{
    use PlanExecuteLoop;
